...
const generateCalendarDays = (year: number, month: number) => {
    ...
    const daysToShow: Array<{ day: number; isCurrentMonth: boolean }> = [];
            ...
            >
                ...
                <View style={styles.viewModeContainer}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            router.push("/(dashboard)/add-appointment")
                        }
                    >
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.syncInfoText}>
                        All appointments are automatically synchronized with
                        your connected calendars. Changes made in this agenda
                        will reflect in Google Calendar and vice versa.
                    </Text>
                </View>
            </ScrollView>
        </View>
